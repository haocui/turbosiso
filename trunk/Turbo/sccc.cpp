/** \file
 * 
 * \brief Serial Concatenated Convolutional Codes (SCCCs) of coding rate 1/4
 *
 * Implements SCCCs using a turbo decoder with a SISO NSC module and a SISO RSC module.
 * 
