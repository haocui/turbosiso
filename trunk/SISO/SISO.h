/** \file
 *
 * \brief Soft Input Soft Output (SISO) modules class header
 */
...
inline itpp::vec threshold(const itpp::vec &in, const double &value)
{
...
inline itpp::mat threshold(const itpp::mat &in, const double &value)
{
